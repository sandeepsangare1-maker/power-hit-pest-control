...
export class Backend implements backendInterface {
    ...
    async submitTestimonial(arg0: string, arg1: string, arg2: bigint, arg3: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async updateBookingStatus(arg0: bigint, arg1: string): Promise<BookingRequest> {
        if (this.processError) {
            try {
